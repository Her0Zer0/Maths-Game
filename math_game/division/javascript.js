...
function startCountdown(){
    ...
    action = setInterval(function(){
        ...
        if(timeremaining == 0){//gameover
            ...
            document.getElementById("gameOver").innerHTML = "<p>Time Is Up!</p><p>Your score is " + score + "</p>";
            //hide timer box
            hide("timeremaining");
            hide("correct");
            hide("wrong");
...
function generateQA(){
    ...
    var answers = [Number(correctAnswer).toFixed(2)];
    ...
    for(i=1; i < 5; i++){
        if(i != correctPosition){
            ...
            do{
                ...
                if(a >= b){//a wrong answer 
                    wrongAnswer = (Number(a) / Number(b)).toFixed(2);
                }
                else{
                    wrongAnswer = (Number(b) / Number(a)).toFixed(2);
                }
